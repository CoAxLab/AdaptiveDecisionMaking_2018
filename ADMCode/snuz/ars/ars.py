...
import numpy as np
import gym
from ADMCode.snuz.ars import logz
import ray
from ADMCode.snuz.ars import utils
from ADMCode.snuz.ars import optimizers
from ADMCode.snuz.ars.policies import *
import socket
from ADMCode.snuz.ars.shared_noise import *
        ...
        for i in range(num_rollouts):
            ...
            if evaluate:
                ...
                reward, r_steps = self.rollout(
                    shift=0., rollout_length=self.env.spec.timestep_limit)
...
class ARSLearner(object):
    ...
    def train(self, num_iter):
        ...
        for i in range(num_iter):
            ...
            iter_scores.append(np.mean(rewards))
...
def run_ars(env_name='MountainCarContinuous-v0',
    ...
    ARS = ARSLearner(
        ...
        num_deltas=hp.n_directions,
        deltas_used=hp.deltas_used,
        step_size=hp.step_size,
        delta_std=hp.delta_std,
        logdir=logdir,
        rollout_length=hp.rollout_length,
        shift=hp.shift,
        params=hp,
        seed=hp.seed)

    return ARS.train(hp.num_episodes)
